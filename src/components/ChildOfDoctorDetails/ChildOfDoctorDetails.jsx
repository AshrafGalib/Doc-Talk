...
const ChildOfDoctorDetails = ({regNmbr,doctors}) => {
      ...
      className="rounded-xl h-[260px] " />
         ...
         <div className=''>
            ...
            <div className='flex gap-5 items-center'>
                ...
                <div>
                    {
                        doctor.availability.map((time,index)=><div key={index} className=" ml-2 mt-5  text-xs badge badge-soft badge-success">{time.day}</div>)
                    }
                </div>
            </div>
...
export default ChildOfDoctorDetails;